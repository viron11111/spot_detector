...
port = 1883
topic = "camera_101/picture"
client_id = f'left_camera_101'
username = 'andy'
password = 'cannondale'
...
def take_picture(picam2, mqttc):    
    ...
    #print("here1")
    #time.sleep(2)
    file_name = "camera_101_" + file_time + ".jpg"
    #print("here2")
    #time.sleep(2)
    ...
    with open("/home/andy/software/pictures/" + file_name,'rb') as file:    
        ...
        pic_payload = json.dumps({"file_name01":file_name, "picture":image_data})

    publish.single("camera_101/picture", payload=pic_payload, qos=2, hostname='192.168.1.245', port=1883, auth = {'username':"andy", 'password':"cannondale"})
